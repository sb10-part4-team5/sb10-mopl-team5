...
import com.codeit.team5.mopl.global.web.ws.stomp.listener.StompDisconnectEventHandler;
...
class StompDisconnectEventHandlerTest {
    ...
    void handleWebSocketDisconnectListener_Success() {
        ...
        SessionDisconnectEvent event = new SessionDisconnectEvent(this, message, "session-id", null);
