...
class DbLoginSessionStoreTest {
    ...
    void findCurrentSessionId_existingSession_returnsSessionId() {
        ...
        when(loginSessionRepository.findFirstByUserIdAndExpiresAtAfterOrderByExpiresAtDesc(eq(userId), any(Instant.class)))
        ...
        verify(loginSessionRepository).findFirstByUserIdAndExpiresAtAfterOrderByExpiresAtDesc(eq(userId), any(Instant.class));
    }
