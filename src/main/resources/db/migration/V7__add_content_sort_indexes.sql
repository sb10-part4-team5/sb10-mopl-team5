...
CREATE INDEX idx_content_stats_watcher_count ON content_stats (watcher_count);
...
CREATE INDEX idx_content_stats_average_rating ON content_stats (average_rating);
