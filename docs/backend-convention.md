...
Spring Boot는 메인 애플리케이션 클래스를 최상위 패키지에 두고 도메인 기반으로 패키지를 구성할 것을 권장한다.
...
[Google Java Style Guide §5](https://google.github.io/styleguide/javaguide.html#s5-naming) 기반.
...
- 한 줄 최대 길이: **120 chars**. ([Google Java Style §4.4](https://google.github.io/styleguide/javaguide.html#s4.4-column-limit))
- 파일 끝 개행: **필수**.
...
Spring Framework는 **생성자 주입**을 명시적으로 권장한다.
([Spring Framework - Constructor-based Dependency Injection](https://docs.spring.io/spring-framework/reference/core/beans/dependencies/factory-collaborators.html#beans-constructor-injection))
...
[Spring Framework - Transaction Management](https://docs.spring.io/spring-framework/reference/data-access/transaction/declarative.html) 기반.
...
[Jakarta Persistence 3.1 Specification](https://jakarta.ee/specifications/persistence/3.1/) +
[Spring Data JPA Reference](https://docs.spring.io/spring-data/jpa/reference/) 기반.
...
[MapStruct Reference Documentation](https://mapstruct.org/documentation/stable/reference/html/) 기반.
...
[Jakarta Bean Validation 3.0](https://jakarta.ee/specifications/bean-validation/3.0/) 기반.
...
[Spring Framework - Annotated Controllers - Exceptions](https://docs.spring.io/spring-framework/reference/web/webmvc/mvc-controller/ann-exceptionhandler.html) +
[Spring Boot - Error Handling](https://docs.spring.io/spring-boot/docs/current/reference/html/web.html#web.servlet.spring-mvc.error-handling) 기반.
...
[Microsoft REST API Guidelines](https://github.com/microsoft/api-guidelines/blob/vNext/Guidelines.md) 기반.
...
[Spring Boot - Logging](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.logging) 기반.
...
[Testcontainers Documentation](https://testcontainers.com/getting-started/) 기반.

### 테스트 전략

| 테스트 유형 | 대상 | 작성 기준 |
|---|---|---|
| 통합 테스트 | Controller / 전체 흐름 | 모든 API 엔드포인트 |
| 단위 테스트 | Service / 도메인 로직 | 복잡한 비즈니스 로직 |
| 슬라이스 테스트 | Repository | 복잡한 쿼리 검증 |
...
[Flyway Documentation](https://documentation.red-gate.com/fd/) 기반.
...
[The Twelve-Factor App - Config](https://12factor.net/config) 기반.
